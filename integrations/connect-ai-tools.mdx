...
This page covers connecting an assistant you sign in to yourself. For a script, a CI job or an agent that runs with nobody signed in, use an [API key](/integrations/api-keys) instead.
